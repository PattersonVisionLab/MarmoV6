...
% UPDATED 9/1/20 to match MarmoV5 in Shanna's rig, but not for the juicer
...
% Last Modified by GUIDE v2.5 19-Aug-2024 16:32:16
...
% Hints: get(hObject,'String') returns contents of RotationAngleText as text
%        str2double(get(hObject,'String')) returns contents of RotationAngleText as a double
