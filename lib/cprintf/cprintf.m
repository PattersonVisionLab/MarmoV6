...
%
%    Note: Matlab supports both bold and underline only on R2025a+; on previous
%          releases only one of them can be used in a single cprintf command.
%          Bold and underline can always be mixed by using separate commands.
%
...
%       be underlined i.e., the style can be either bold or underline, not both.
%       On R2025a or newer, using the new JavaScript desktop, the style can be
%       both bold and underline at the same time.
%
...
% $Revision: 1.21 $  $Date: 2026/04/22 15:40:00 $
