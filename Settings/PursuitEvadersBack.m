...
P.BackgroundFolder = 1;  % if one, use backgrounds draw from BackFolder
S.BackgroundFolder = 'Use background folders';
...
P.gaborStep = 1.0; % no random extra motion, all linear moves ; % was 2.5; %5 angular steps in turning
...
P.gaborSpeed = 4; % degrees per sec, contstant velocity
S.gaborSpeed = 'Speed of moving target (constant)';
P.gaborCapture = 0.4;  % force her to look at it this long before change contrast
S.gaborCapture = 'Duration she must look before contrast change:';
P.gaborHold = 0.8; % duration to hold target for reward
...
P.probFixJuice = 0.5;  % prob for a drop of juice on fixation
