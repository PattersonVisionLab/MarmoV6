...
classdef FrameControl < handle
  ...
  methods (Access = public)
     ...
     function [c,dx,dy,rot] = upload_C(o)
          c = o.c;
          dx = o.dx;
          dy = o.dy;
          rot = o.rot;
    ...
    function [currentTime,x,y] = grabeye_run_trial(o,state,eyepos,pupil)
          ...
          [x,y] = o.rotatecore(x,y,o.rot);     
    end
    
    function [x2,y2] = rotatecore(o,x,y,rot)
          if (rot)
              anga = rot * pi /180;
              ca = cos( anga);
              sa = sin( anga);
    ...
    function [updateGUI,screenTime] = screen_update_run_trial(o,state)  
       ...
       if o.showEye
          ...
          Screen('FrameOval',o.winPtr,o.eyeColor,[cX-eR cY-eR cX+eR cY+eR],2);
       end
    ...
    function update_eye_calib(o,c,dx,dy,rot)
          o.c = c;
          o.dx = dx;
          o.dy = dy;
          o.rot = 0;
